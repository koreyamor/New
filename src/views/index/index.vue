<template>
  <div>
        ...
        >
          ...
          <div class="row">
            <div
              ...
              v-for="(tolist, listi) in tip.list"
              :key="listi"
            >
              <button class="btn btn-light w-100">
                <h4 class="mb-1">{{ tolist.value }}</h4>
                <small class="text-muted">{{ tolist.name }}</small>
              </button>
            </div>
          </div>
        </el-card>
    ...
    <el-row :gutter="20" class="mt-3">
      <el-col :span="12">
        <el-card class="box-card" style="height: 280px" shadow="never">
          <div slot="header" class="clearfix">
            <span>销售情况统计</span>
            <el-button style="float: right; padding: 3px 0" type="text"
          ...
          <div class="media align-items-center border">
            <span class="padding py-4 px-3 bg-light border-right"
              >昨日销量</span
            >
      ...
      <el-col :span="12">
        <el-card class="box-card" style="height: 280px" shadow="never">
          ...
          <el-table :data="tableData" height="180" border style="width: 100%">
            ...
            <el-table-column prop="num" label="销量" width="60px"> </el-table-column>
          </el-table>
        </el-card>
      </el-col>
    </el-row>
